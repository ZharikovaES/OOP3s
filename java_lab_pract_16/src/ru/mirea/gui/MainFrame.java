...
import ru.mirea.exceptons.EmptyOrderListException;
import ru.mirea.exceptons.NoFreeTablesException;
import ru.mirea.menu.Dish;
import ru.mirea.menu.Drink;
import ru.mirea.menu.DrinkTypeEnum;
import ru.mirea.orders.InternetOrder;
import ru.mirea.orders.Order;
import ru.mirea.orders.TableOrder;
import ru.mirea.orders.managers.InternetOrderManager;
import ru.mirea.orders.managers.TableOrderManager;
...
public class MainFrame implements Runnable{
    ...
    public void addOrder(int tNum, boolean mature){
        TableOrder to = new TableOrder(mature ? Customer.MATURE_UNKNOWN_CUSTOMER : Customer.NOT_MATURE_UNKNOWN_CUSTOMER);
        try{
            tom.add(to, tNum);
    ...
    public void addOrder(String[][] ord){
        ru.mirea.menu.MenuItem[] itms = new MenuItem[ord.length];
